...
/*! \brief Get current Web Url
 *
 *  \return current Web Url hosting
 */
-(NSString *)webURL;

/*! \brief Get current databaseName
 *
 *  \return current databaseName
 */
@property (nonatomic,strong) NSString * databaseName;

/*! \brief Get current list of databaseName
 *
 *  \return current list of databaseName
 */
