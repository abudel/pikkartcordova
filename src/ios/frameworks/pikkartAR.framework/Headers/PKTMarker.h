 ...
 *
 *  \return tell if PKTMarker has been tracking
 */
@property (nonatomic, getter=isTracking) bool tracking;

/*! \brief arLogoEnabled property
 *
 *  \return tell if PKTMarker has AR Logo functionality
 */
@property (nonatomic,getter=isArLogoEnabled) bool arLogoEnabled;

/*! \brief patternCode property
 *
 *  \return ARLogo pattern code
 */
