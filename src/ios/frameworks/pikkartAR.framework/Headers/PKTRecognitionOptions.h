...
typedef NS_ENUM(int, PKTRecognitionStorage) {
    ...
    PKTDATABASE, /*!< Search marker in local database and eventually in cloud database. */
    PKTPUREDATABASE, /*!< Search marker in local database only. */
    PKTDISCOVER, /*!< Enable Discover mode. */
    PKTDEEPRECOGNITION, /*!< Enable Recognition with Deep Learning mode. */
    PKTCALIBRATION /*!< User for Device Calibration. */
};
 ...
 *  \param mode PKTRecognitionMode parameter
